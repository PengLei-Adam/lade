...
import (
	...
	"github.com/PengLei-Adam/lade/framework/gin/binding"
	"github.com/gin-contrib/sse"
	"github.com/golang/protobuf/proto"
	"github.com/stretchr/testify/assert"

	testdata "github.com/PengLei-Adam/lade/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/PengLei-Adam/lade/framework/gin.handlerNameTest$", c.HandlerName())
}
